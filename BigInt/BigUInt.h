...
class BigUInt : public DigitVector {
    ...
    static const size_t s_karatsubaLowerLimit = 120ul;
...
public:
    ...
    BigUInt(rlcIterator it, rlcIterator endIt) : DigitVector({it, endIt}) { assert(isWellFormed()); }
...
private:
    ...
    static void subtractViaIterators(rlIterator thisIt, const rlIterator thisEnd, rlcIterator rhsIt, const rlcIterator rhsEnd);
